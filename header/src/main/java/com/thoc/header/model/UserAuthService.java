...
import com.thoc.header.model.data.ApiResponse;

@Service
public class UserAuthService implements com.thoc.header.contract.UserAuthService
{
	/**
	 * Rest client.
	 */
	 ...
	 */
	@Override
	public com.thoc.header.contract.UserAuthService login(String username, String password)
	{
	 ...
	 */
	@Override
	public com.thoc.header.contract.UserAuthService validateAuthToken(String token) 
	{
	...
	public UserToken getUserDetails()
	{
		...
		return this.modelMapper.map(content, com.thoc.header.model.data.UserToken.class);
	}
}

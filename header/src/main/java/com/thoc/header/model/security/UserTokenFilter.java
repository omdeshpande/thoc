package com.thoc.header.model.security;
...
import com.thoc.header.contract.UserAuthService;
...
public class UserTokenFilter extends OncePerRequestFilter
{
	...
	{
		if (this.userAuthService.validateAuthToken(authToken).isSuccess()) {
			UserDetails user = this.userService.loadUserByUsername(this.userAuthService.getUserDetails().getUsername());
